...
is_ocboot_subcmd() {
    local subcmds="install upgrade add-node add-lbagent backup restore setup-container-env switch-edition clickhouse setup-ai-env start stop set-calico-version"
